# Disclaimer
The contents of this folder are taken from the official ChatAFL repository and redistributed under the Apache 2.0 License, which is included in the root of this repository. The only modification made is that we are referencing the `aflnet` from the official repository, rather than copying it directly.
